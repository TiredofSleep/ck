...
**Tier counts (updated April 1 2026 — D8-D18c, C-tier audit):** Tier D: 19 (D1-D11,D14-D17,D18a,D18c) | Tier C: 6 (C5,C6,C7,C12,C16,C19) | Tier B: 8 (B1,B4,B5,B6,B7,B8,B9) | Tier A: 5 (A2,A4,A10,A11,A12). **D18a:** Phi orbit graph complete. **D18c:** TSML[v][Phi(v)]=7 universal bridge. **D18d OPEN:** T*=5/7 forced vs calibrated. **C-tier audit:** 12 absorbed/reclassified; 6 genuine survivors remain.
