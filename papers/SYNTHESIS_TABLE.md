...
| A15 | Circulation Operator: object satisfying all 7 corridor constraints — phase cycling, invariant preservation, boundary collapse, recursion, cycle alignment, dual domain, return path | A | No | No | No | Explicit object satisfying all 7 constraints verified against corridor atlas |

**Tier counts (updated March 31 2026, B1+A14+A15 added):** Tier D: 4 | Tier C: 11 | Tier B: 2 | Tier A: 15
