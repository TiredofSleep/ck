...
| B10 | Wobble Branch Test (April 1 2026): Wob_norm(b,k,p)=Wob(b,k)/Wob(b,p) is IDENTICAL in g=3 and g=7 worlds (branch separation claim FALSE). C10∪D10={1,2,3,4,6,7,8,9} is generator-independent. Surviving theorem: Wob(k) period-10, drops at multiples of 5, Wob(k)→4/5 as k→∞ (equidistribution). Wob(143,9)=8/9 and period-10 identity Wob(10m)=4/5 verified. A12 branch separation demoted from Tier A conjecture. | B | ✓ | ✓ (verified) | ✓ | Wob_norm differs between g=3 and g=7 for any b — computationally falsifiable |
...
**Tier counts (updated April 1 2026 — D20-D22, B10-B11, D-tier audit):** Tier D: 26 (D1-D11,D14-D22,D18a,D18c,D18d) | Tier C: 6 (C5,C6,C7,C12,C16,C19) | Tier B: 9 (B1,B4,B5,B6,B7,B8,B9,B10,B11) | Tier A: 5 (A2,A4,A10,A11,A12). **D22:** Corridor portrait complete; 4 spine positions ordered and amplitude-profiled; t=1/2 is inheritance boundary. **THE CORRIDOR IS MAPPED.** D20+D21: inheritance hierarchy and CE fixed-point theorem complete the CREATE=5 overdetermination. B10: branch separation negative result (honest); B11: corridor midpoint via sine-maximum uniqueness.
