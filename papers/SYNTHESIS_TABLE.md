...
**Tier counts (updated April 1 2026 — D8-D17 promotions):** Tier D: 17 (D1-D11,D14-D17) | Tier C: 9 (C3,C5,C6,C7,C9,C12,C16,C19,C20) | Tier B: 8 (B1,B4,B5,B6,B7,B8,B9) | Tier A: 5 (A2,A4,A10,A11,A12). **D14:** Si(2π)/π exact corridor mean. **D15:** coprime window b-independence. **D16:** BHML 28=2+11+2+13 zone partition. **D17:** W=3/50 from (Z/10Z)* group structure. **D7:** Phi(5)=5; T*=5/7=CREATE/HARMONY. D7 resolves C21 target stated in C20.
