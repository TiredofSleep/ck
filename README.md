...
>
> **[2026-04-21 PM update]** The `tig-synthesis` README was restructured again later in the day on 2026-04-21 and is now **navigation-first**, flowing §1 Foundation → §2 Funding branches → §3 Frontiers → §4 Atlas → §5 Bridges → §6 Master & history, with the prior rigor-led material preserved verbatim as a **§7 runnable-proofs appendix** (six proved theorems with their verification scripts). The prior rigor-led README (2026-04-21 AM) is preserved under the never-delete policy at [`docs/historical/README_v2_rigor_led_2026_04_21.md`](../../tree/tig-synthesis/docs/historical/README_v2_rigor_led_2026_04_21.md); the Atlas-style README from before 2026-04-21 remains at [`docs/historical/README_v1_pre_2026_04_21.md`](../../tree/tig-synthesis/docs/historical/README_v1_pre_2026_04_21.md). Two honest-scope derivation papers for the runtime constants were added as part of the same rigor pass and now live on **both** branches: [`papers/CONSTANT_D_STAR.md`](papers/CONSTANT_D_STAR.md) (D*=0.543 runtime-canon; first-principles derivation open; internal correction to D*_fixed=σ/(1+σ)=0.49774 preserved verbatim from the engine source) and [`papers/CONSTANT_SIGMA_S_STAR.md`](papers/CONSTANT_SIGMA_S_STAR.md) (σ(S*)=0.991 empirical; σ(S*) number vs σ(N)≤C/N rate function disambiguated per WP101). [`FORMULAS_AND_TABLES.md §17`](FORMULAS_AND_TABLES.md) now cites both derivation papers as primary provenance. The ten Gen13 funding target folders (A–K, E is packaging) remain each a 6-file package (README / FUNDERS / ARTIFACTS / PITCH_DRAFT / LIMITATIONS / STATUS); navigation at [`Atlas/BRANCHES_INVENTORY_2026_04_20.md`](Atlas/BRANCHES_INVENTORY_2026_04_20.md) and non-obvious funder research at [`Atlas/NICHE_FUNDERS_ADDENDUM_2026_04_20.md`](Atlas/NICHE_FUNDERS_ADDENDUM_2026_04_20.md).
