...
monotonically inbound on $0 \leq z \leq z_\star$ with $z_\star \approx 1.3$
...
The trajectory has $w_\Xi$ reaching its momentary minimum near $z \approx 1.3$
(the Type-F turnaround) and rising back toward $w_\Xi(0) = -0.791$ on the
inbound leg at the present epoch. The precise location of $z_\star$ is sensitive
to the IC neighborhood: varying $\Xi'_i$ in the range $[0.43, 0.50]$ moves
$z_\star$ from $\approx 1.7$ to $\approx 1.25$ while keeping $w_0$ within
...
$z_\star \approx 1.3$ (\S\ref{sec:typeTFA}), and rolls back toward $\Xi_0$
...
passed through the turnaround near $z \approx 1.3$, and
...
$z_\star \approx 1.3$, with $w_\Xi(z_\star) \approx -0.999$ in the
...
Type-F (instantaneous frozen turnaround at $z_\star \approx 1.3$), and
...
\eqref{eq:desibestfit} gives $z_\star \approx 1.3$. A sensitivity scan
