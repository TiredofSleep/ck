...
is the critical density today. We restrict to the rolling branch of the
...
reconstructions (e.g., binned, Gaussian-process, or principal-component)
beyond the CPL parametrization, since CPL is monotone by construction
and cannot represent a local minimum at $z_\star \approx 2$. Recent
DR2-era reconstructions \cite{Wang2026QReconstruction,Adil2026Analytic}
indicate the precision and methodology relevant to this test.
...
systems with generalized logarithmic equations of state.
...
quintessence parameter space outside that dichotomy.
\end{remark}
