...
print()
print("  OPERATOR MEANING: ASCEND(6) is the STRUCTURE ceiling of {{1..6}}.")
print("  max+1 = HARMONY exactly when both operators are at or below ASCEND.")
...
print()
print(f"  Row 6 (ASCEND): {len([j for j in range(10) if BHML[6][j]==7])}/10 cells = HARMONY.")
print(f"  This is the max+1 ceiling: every opponent ≤ ASCEND (6) → HARMONY (7).")
...
print()
print("  KEY INSIGHT: max+1=HARMONY threshold makes ASCEND(6) the structural ceiling.")
print("  Every opponent at or below ASCEND gives HARMONY — the physics field saturates.")
print()
