...
is the critical density today. We restrict to the freezing branch of the
...
script \texttt{desi\_xi\_optimize.py} provided as electronic
...
script \texttt{desi\_xi\_optimize.py} (electronic supplementary material)
...
(\texttt{desi\_xi\_fit.py}, \texttt{desi\_xi\_optimize.py}) are available
