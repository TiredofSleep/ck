...
%%%   [V-NATURALNESS]     -- why F_5-lift is THE natural V (open)
%%%   [N_S-DERIVATION]    -- structural origin of HARMONY/(2*N^2) form (open)
%%% ============================================================
...
As one consistency check, the same two primitives admit a
small-integer expression
$n_s = 1 - \mathrm{HARMONY}/(2|\Z/10|^{2}) = 0.9650$ that
matches the Planck~2018 scalar spectral index
$0.9649 \pm 0.0042$ at $0.024\sigma$ ($\sim 0.01\%$); we frame
this as consistency rather than prediction, since a baseline
search finds $\sim 2.4\%$ of small-integer candidate forms also
hit Planck within $1\sigma$. A rigorous structural derivation of
$n_s$ from the substrate is left for future work.
\end{abstract}
