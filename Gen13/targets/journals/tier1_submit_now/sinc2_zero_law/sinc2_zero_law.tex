...
%%%
%%% ACTION: this manuscript is retained as a working draft. The
%%% intended replacement is the First-G Event Localization theorem
%%% (for squarefree b with smallest prime factor p_1: |G_k(b)|=0 for
%%% every k < p_1, and |G_{p_1}(b)|=1 -- the obstruction-free
%%% stability window has width exactly p_1 - 1). This statement is
%%% algebraically complete, genuinely prime-dependent, and already
%%% PROVED in WP34 (36,662 (b,k) pairs, zero exceptions). See
%%% Atlas/SINC2_SHARPEN_DECISION_2026_04_19.md sec.4 for the full
%%% statement and Sprint 35 at
%%% Gen13/targets/clay/papers/sprint35_first_g_event_2026_04_19/
%%% for the journal-ready draft. Do NOT submit sinc^2 manuscript in
%%% current form; Sprint 35 is the intended venue-1 replacement.
