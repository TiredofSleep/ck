...
under both operations into a strict 8-element chain. The pair
...
B.~R.~Sanders and M.~Gish.
\newblock Joint Closure of Two Commutative Binary Operations on
$\mathbb{Z}/10\mathbb{Z}$ and Per-Coordinate Fuse Data on the
$4$-Core.
