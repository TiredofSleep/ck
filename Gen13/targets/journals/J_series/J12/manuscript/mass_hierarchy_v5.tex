...
%%%
%%% Companion: J10 (Sprint 18 Dark Sector, Sanders + Johnson, PRD)
...
\item J10 (Sanders + Johnson, PRD) -- the dark-sector trinity
companion using \texttt{predict\_dark\_sector()} on the same
module.
\item J23 (Sanders + Johnson, foundation) -- discrete Dirac on
