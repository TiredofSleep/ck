# Cover letter — J28: Mathieu M_22 Substrate-Prime: Order-Factorization Coincidences
...
Verification script: `(M_22 verification script)` runs with `numpy + sympy + math` on a standard laptop in under 5 minutes.
