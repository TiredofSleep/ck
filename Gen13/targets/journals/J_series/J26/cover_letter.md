# Cover letter — J26: LATTICE: Paradoxical Information Algebras on the Z/10Z Substrate
...
**Manuscript title:** *LATTICE: Paradoxical Information Algebras on the Z/10Z Substrate*
...
Verification script: `(lattice script)` runs with `numpy + sympy + math` on a standard laptop in under 5 minutes.
