# Cover letter — J26: F_p Extensions of CL_BHML: Universality Across Six Prime Fields
...
- The result completes the F_p-universality picture for the lens family: TSML side (J14, prior submission) plus BHML side (this paper) give the field-invariance backbone for the three-substrate architecture (J23).
...
- J14 — *F_p Universality: The Operator-Substrate Construction over Prime Fields*, Algebra Universalis (TSML side, this paper extends to BHML)
- J25 — *The CL Forcing Axioms: A1-A9 Uniquely Force the Canonical Composition Lattice*, Algebraic Combinatorics (parent forcing framework)
- J23 — *The Three-Substrate Architecture*, Algebra Universalis (provides the BHML substrate definition)
...
This is the second paper from this research program targeting *Communications in Algebra* (after J15, *Galois D_4 over LMFDB 4.2.10224.1*). Per-venue cap is 1/quarter; the venue is within budget.
