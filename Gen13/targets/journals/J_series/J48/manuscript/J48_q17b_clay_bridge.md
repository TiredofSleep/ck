...
* **[J29]** — Q17-A: 5D Force Vector as CRT Fourier Embedding of $\mathbb{Z}/10\mathbb{Z}$ into $\mathbb{R}^5$ (AMM, Sanders + Calderon Jr.). The Tier-A proved-algebra companion. This paper's $\chi$ and $\sigma$-orbit data come from the same underlying CRT decomposition.

**Co-citing companions (parallel-track submissions).**

* **[J51]** — G6+G7+G8 spectral consolidation (European J Combin, Sanders + Luther). Layer-1, Layer-3, Layer-4 polynomial / period / spectral results that this paper builds on.
* **[J5]** — Crossing Lemma (JCT-A or JPAA, Sanders + Mayes). The information-generation framing of $\sigma$-non-associativity that gives the 6-cycle its structural meaning.
