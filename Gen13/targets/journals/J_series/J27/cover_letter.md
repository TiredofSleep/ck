# Cover letter — J27: DKAN Two-Coding: TSML_8 Geometric vs BHML_10 Arithmetic
...
**Manuscript title:** *DKAN Two-Coding: TSML_8 Geometric vs BHML_10 Arithmetic*
...
Verification script: `(DKAN script)` runs with `numpy + sympy + math` on a standard laptop in under 5 minutes.
