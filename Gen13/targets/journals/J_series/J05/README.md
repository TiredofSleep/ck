# J05 — Crossing Lemma: Non-Associativity as Information Generation in Finite Magmas
...
J01, J02, J04 (foundational predecessor — squarefree-stability is the hypothesis we lean on)
...
- Cited J04 (First-G) as foundational predecessor — squarefree hypothesis used throughout.
...
- J04 status (Integers) currently FORMAT, not yet submitted — verify J04 is at least submission-ready before this paper goes out, since the cover letter cites it as a companion.
