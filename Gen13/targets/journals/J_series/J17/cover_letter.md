# Cover letter — J17: Universal Orthogonality Principle (UOP): Theorem 0
...
**Manuscript title:** *Universal Orthogonality Principle (UOP): Theorem 0*
...
Verification script: `(UOP verification script — corpus)` runs with `numpy + sympy + math` on a standard laptop in under 5 minutes.
