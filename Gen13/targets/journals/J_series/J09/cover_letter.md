# Cover letter — J09: TSML 73 Cells / BHML 28 Cells: Lens-Invariant Cell Counts on the Z/10Z Composition Lattice
...
Verification script: `(corpus: 73/28 verification scripts)` runs with `numpy + sympy + math` on a standard laptop in under 5 minutes.
