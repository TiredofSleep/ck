# Cover letter — J15: The Discrete Sinc² Identity in Quantum Mechanics

**To:** Editors, *J Math Phys*
...
**Manuscript title:** *The Discrete Sinc² Identity in Quantum Mechanics*
...
Verification script: `(QM verification script)` runs with `numpy + sympy + math` on a standard laptop in under 5 minutes.
