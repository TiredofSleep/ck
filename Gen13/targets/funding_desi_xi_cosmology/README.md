...
A funding-outreach container for the **ξ-field cosmology** program — the canonical scalar-field action
...
## What the ξ action gives you (funder-facing summary)
...
## The research question (what the funder funds)
...
This is in contrast to, e.g., Branch C (First-G crypto) where C.A. Luther is previously-credited but no-longer-actively-collaborating. Johnson's role here is ongoing, and the funder-facing language should reflect that.
