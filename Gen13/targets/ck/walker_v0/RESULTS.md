...
Runtime: 57.2 s, CPU only, fully seeded. Reproduce: `python run_all.py`.
...
|---|---|---|---|
| uniform | 0.39992 | 6240 | no classification |
| **Gap Router** | 0.00319 | 6228 | type accuracy 100%, 5 channels frozen |
| oracle | 0.00325 | 6228 | ground-truth types |
