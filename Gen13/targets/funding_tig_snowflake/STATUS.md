...
- [ ] **R1**: Locate CRYSTALOS log with χ² = 22.03 output. Search `old/Gen10/`, `archive_imports/`, R16 desktop Jan 2026 files, ClaudeChat export for commit `9fdac5c3`.
- [ ] **R2**: Author null-hypothesis specification (`docs/archive_jan2026/snowflake_null_spec.md`). Content: H₀ statement, partition scheme P, partition count k, sample size N, degrees of freedom, stopping rule, test convention.
...
- **Blocker 1** (absolute): R1 CRYSTALOS log recovery. Nothing ships without the raw numbers being re-derivable from a preserved log.
