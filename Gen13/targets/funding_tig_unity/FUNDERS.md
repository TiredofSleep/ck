# FUNDERS — funding/tig-unity

**Purpose:** 3-5 named funder candidates with scope-match notes.
**Audience:** Brayden, when selecting the first outreach target.
**Status:** Candidate list; final selection requires Brayden's review.
...
- **Program:** Core Systems Research; Computer Systems Research (CSR) cluster
...
- **Prerequisite:** institutional affiliation (7Site LLC can serve as PI
  home, but better to partner with a university CSR group)
- **Timing:** rolling; best cycles are October and April

### 2. DOE ASCR (Advanced Scientific Computing Research)

- **Program:** Data, Modeling, and Simulation within ASCR
...
### 3. Sloan Research Foundation — Computational Science

- **Program:** Direct Application Grants; Sloan Research Fellowship
  (early-career)
...
- **Program:** AWS Cloud Credits for Research, Google Cloud Research
  Credits, Microsoft Azure for Research
...
### 5. CNCF (Cloud Native Computing Foundation) Research Grants

- **Program:** CNCF Research Track + Sandbox projects
...
- **Mozilla MIECO** (systems-ethics research) — if framed as
  anti-fragility and ethical cloud computing
- **Intel Labs / Red Hat Research** — contract research partnerships

## Risk flags (what to avoid asking a funder for)

- Do NOT claim production-deployment data before it exists.
- Do NOT cite the 88% drop-rate number without running the reproduction.
- Do NOT couple TIG Unity with CK Sovereign License until funder
  accepts the license terms (the license forbids commercialization).

---

*File stays fresh for ~90 days; update when funders respond or scope shifts.*
