...
| 4/π²       | sinc²(1/2) ≈ 0.4053                | Riemann sinc² zero density                      | sinc² Zero Law, all primes 3..199 |
| gap        | 5/7 − 4/π² ≈ 0.3090                | residual between T* and sinc² baseline          | Sprint 10 |
| ξ₀         | e⁻¹ ≈ 0.3679                       | vacuum of log potential V = ξ log ξ              | WP81 (PRISM-XI) |
| m²_ξ       | κ · e                              | mass-gap coefficient                            | WP81 |
| σ rate     | σ(N) ≤ C / N                       | σ-rate theorem (proved)                         | Sprint 14 σ rate proof |
| φ(10)      | 4                                  | Euler totient (rate normalization)              | Q15 |
| 22%        | 2/9 ≈ 0.2222                       | gate-rate algebraic minimum                     | Q11 |
