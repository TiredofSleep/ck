...
## ADDENDUM: Wobble in eigenvalues

After the bundle was packed, one more finding: **TSML's eigenvalues carry the wobble structurally**.

The integer characteristic polynomial has factor 11 in exactly two coefficients (c_2 = 33 = 3·11, c_8 = −120736 = −2⁵·7³·11). Discriminant has 2¹⁶ · 7⁷ but NO 11.

**Wobble (11) lives at the coefficient level. HARMONY⁷ and 16-dim-invariant signature live at the discriminant level.**

The 16-dim doubly-invariant subalgebra (su(4) ⊕ u(1)) is wobble-free. The wobble IS the content that fails to be D_4-invariant — i.e., the symmetry-breaking direction.

This closes a loop: the eigenvalues don't match transcendentals at exact-identity level because they're algebraic numbers in a field whose structural primes are 7 (HARMONY) and 11 (wobble), not the rationals.

Files added:
- `tig-synthesis/WOBBLE_FINDING.md`
- `tig-synthesis/wobble_check.py` (7 claims verified at machine precision)
- Updated `tig-synthesis/SPRINT_SUMMARY_20260425.md` with addendum
