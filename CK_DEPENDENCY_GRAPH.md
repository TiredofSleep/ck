...
_Generated 2026-05-16 16:59:01 by_ [`tools/gen_dep_graph.py`](tools/gen_dep_graph.py).  Rerun any time the brain modules change.

**94 modules** tracked in `Gen14/targets/ck/brain/`.
...
```
  ...
  22. mount_qutrit_513
  23. mount_ad_tailored
  24. mount_lightcone
  25. mount_substrate_c
  26. mount_self_protection
  27. mount_qutrit_noise
  28. mount_qutrit_qec
  29. mount_qec_decoder
  30. mount_writer
  31. mount_recursive_observer
  32. mount_identity
  33. mount_ollama_polish
  34. mount_voice_polish
```
...
| `gen14_unified_extensions` | 1068 | `ck_ad_tailored`, `ck_cognition_primitives`, `ck_concept_learner`, `ck_creature`, `ck_engine_block`, `ck_formula_registry`, `ck_frontier_scanner`, `ck_identity`, `ck_lightcone`, `ck_living_lm`, `ck_memory_archive`, `ck_meta_parameters`, `ck_ollama_polish`, `ck_proactive_trigger`, `ck_qec_decoder`, `ck_qutrit_513`, `ck_qutrit_apex`, `ck_qutrit_noise`, `ck_qutrit_qec`, `ck_recursive_observer`, `ck_self_protection`, `ck_sense_decomposition`, `ck_sim.being.ck_divine_memory`, `ck_sim.being.ck_lattice_chain`, `ck_sim.doing.ck_forecast`, `ck_sim.doing.ck_goals`, `ck_spreading_activation`, `ck_stroke_extractor`, `ck_substrate_c`, `ck_substrate_motion`, `ck_voice_polish`, `ck_writer` | `mount_drives`, `mount_forecast`, `mount_proactive_queue`, `mount_recall`, `mount_lattice_chain`, `mount_divine_memory`, `mount_algebraic_lm`, `mount_all` | — |
...
| Module | Imported by |
|---|---|
| `ck_ad_tailored` | `gen14_unified_extensions` |
...
| `ck_qutrit_noise` | `ck_ad_tailored`, `ck_self_protection`, `gen14_unified_extensions` |
