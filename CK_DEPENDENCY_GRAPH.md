...
_Generated 2026-05-16 17:15:36 by_ [`tools/gen_dep_graph.py`](tools/gen_dep_graph.py).  Rerun any time the brain modules change.

**95 modules** tracked in `Gen14/targets/ck/brain/`.
...
```
  ...
  25. mount_lightcone
  26. mount_substrate_c
  27. mount_self_protection
  28. mount_qutrit_noise
  29. mount_qutrit_qec
  30. mount_qec_decoder
  31. mount_writer
  32. mount_recursive_observer
  33. mount_identity
  34. mount_ollama_polish
  35. mount_voice_polish
```
