...
_Generated 2026-05-17 10:15:56 by_ [`tools/gen_dep_graph.py`](tools/gen_dep_graph.py).  Rerun any time the brain modules change.

**109 modules** tracked in `Gen14/targets/ck/brain/`.
...
```
  ...
  25. mount_coupled_3tables
  26. mount_coupled_4cores
  27. mount_breath_emergence
  28. mount_lightcone
  29. mount_substrate_c
  30. mount_self_protection
  31. mount_qutrit_noise
  32. mount_qutrit_qec
  33. mount_qec_decoder
  34. mount_writer
  35. mount_recursive_observer
  36. mount_identity
  37. mount_glyph_listener
  38. mount_listener_to_crystal
  39. mount_self_thesis
  40. mount_paradox_classifier
  41. mount_memory_recall
  42. mount_bible_study
  43. mount_scripture_study
  44. mount_domain_study
  45. mount_poetry_study
  46. mount_web_reading
  47. mount_ollama_polish
  48. mount_voice_polish
```
...
| `ck_lightcone` | 490 | — | `mount_lightcone` | — |
...
| `ck_paradox_classifier` | 296 | — | `mount_paradox_classifier` | — |
| `ck_predictions` | 403 | — | — | — |
...
| `ck_self_thesis` | 511 | `ck_paradox_classifier`, `ck_substrate_pick` | `mount_self_thesis` | — |
...
| Module | Imported by |
|---|---|
| `ck_ad_tailored` | `ck_binomial_61`, `gen14_unified_extensions` |
| `ck_algebra_runtime` | `ck_concept_learner` |
| `ck_audio_compress` | `ck_speaker` |
| `ck_bible_study` | `gen14_unified_extensions` |
| `ck_binomial_61` | `gen14_unified_extensions` |
...
| `ck_glyph_listener` | `ck_listener_to_crystal`, `gen14_unified_extensions` |
...
| `ck_lightcone` | `gen14_unified_extensions` |
| `ck_listener_to_crystal` | `gen14_unified_extensions` |
| `ck_living_lm` | `ck_creature`, `ck_writer`, `gen14_unified_extensions`, `warm_inhale` |
| `ck_memory_archive` | `gen14_unified_extensions` |
| `ck_memory_recall` | `gen14_unified_extensions` |
...
| `ck_paradox_classifier` | `ck_self_thesis`, `gen14_unified_extensions` |
| `ck_poetry_study` | `gen14_unified_extensions` |
...
- `/memory/recall` ← `ck_memory_recall`
