...
tables; and as the unique odd prime appearing in the discriminant
$-2^6 \cdot 3^2 \cdot 71$ of the quartic LMFDB number field $4.2.10224.1$
that governs the closed-form runtime attractor on the same substrate.
...
\item \emph{Independent rung B.} $\HARM(T_{\{1,\ldots,9\}}) = 71$
  ...
  equivalently the unique odd prime in
  $\disc(4.2.10224.1) = -2^{6} \cdot 3^{2} \cdot 71$;
...
71-rung (sub-magma HARMONY count $=$ lens-disagreement count $=$ Galois
prime in $\disc(4.2.10224.1)$). \textbf{COMPUTED:} all four rungs
...
$71$ is the unique odd prime $> 3$ in the discriminant
$\disc(f) = -40896 = -2^{6} \cdot 3^{2} \cdot 71$ of the quartic
$f(x) = x^4 + 4 x^3 - x^2 + 2 x - 2 \in \Z[x]$, the polynomial whose
LMFDB identifier is $4.2.10224.1$ and which is identified in
\cite{Sanders2026Attractor} as a defining polynomial of the field of
definition of the closed-form $\TSML+\BHML$-mix runtime attractor at
mixing weight $\alpha = 1/2$.
\end{theorem}
