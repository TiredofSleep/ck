% J15 — Galois D_4 over LMFDB 4.2.10224.1: Number-Field Identification
...
%         and J35 (Journal of Algebra centerpiece, §5.2 Galois part)
% Verification: verify_J12_galois.py (6 sympy checks; PASS at machine
%               precision in ~2 seconds; CC-BY-4.0)
% Companion cited as already-submitted: J02, J35
...
\item \textbf{COMPUTED.} The polynomial discriminant
  ...
  \texttt{verify\_J12\_galois.py} accompanying this paper (runtime
...
\texttt{verify\_J12\_galois.py}, accompanying this paper. It performs
...
\emph{Journal of Algebra}, 2026 (J35). The Galois identification of
