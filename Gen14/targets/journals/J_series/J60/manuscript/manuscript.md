...
- $\mathbb{Z}/3$ = T₂ from J58 (profile 60)
- T₄ from J58 (profile 313, commutative non-group)
...
| 60 | $\mathbb{Z}/3$ |
| 116 | $\mathbb{Z}/4$ |
| 179 | $T_1$ (3×3 non-comm Steiner-like quasigroup from J58) |
| 294 | $-(x + y) \bmod n$ for $n \geq 4$ |
| 313 | $T_4$ (3×3 commutative non-group quasigroup from J58) |
...
- Sanders, B.R. & Gish, M. (2026). [J35] Joint Closure, a Universal Attractor, and an Algebraic Mixing Point. *Journal of Algebra*, submitted.
- Sanders, B.R. & Gish, M. (2026). [J58] The Lo Shu D₄ Orbit Modulo 3: Four Distinct Magmas and a Cumulant Spectrum. *Mathematics Magazine*, submitted.
- Sanders, B.R. & Gish, M. (2026). [J59] Algebraic Rigidity of the σ-Magma on $\mathbb{Z}/10\mathbb{Z}$. *Semigroup Forum*, submitted.
