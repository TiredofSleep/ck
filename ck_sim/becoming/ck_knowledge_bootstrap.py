...
class KnowledgeBootstrapper:
    ...
    def _load_domain_knowledge(self):
        ...
        print(f"  [BOOT] Domain knowledge: {count} TRUSTED entries")
    ...
    def _load_operator_knowledge(self):
        ...
        print(f"  [BOOT] Operator knowledge: {count} TRUSTED entries")
    ...
    def _register_vocabulary(self, enriched: Dict[str, dict]):
        ...
        print(f"  [BOOT] Vocabulary: {count} words registered as TRUSTED")
