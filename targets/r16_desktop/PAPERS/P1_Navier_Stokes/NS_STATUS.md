...
| Main Lemmas | INSERT FROM VAULT (lemma_PH_NS.tex) |
| Proofs | PARTIALLY PROVED (see Gap Resolution) |
| CK Measurement Evidence | EXPANDED (v1.4 engine stack) |
| Discussion | EXPANDED (6 new subsections) |
