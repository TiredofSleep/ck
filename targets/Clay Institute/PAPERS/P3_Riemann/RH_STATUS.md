...
| Coherence Framework | COMPLETE (v1.6: SDV components, Celeste codec formalization, delta=0 iff sigma=1/2) |
...
| Discussion | COMPLETE (calibration kernel, Celeste, sigma=T*, Berry-Keating, cross-problem) (v1.7: D1 first-derivative subsection added) |
