...
- Problem-specific D1 behavior documented for Ricci flow direction, surgery-event signatures
...
- **Calibration reference**: Poincare is solved (Perelman, 2003). D1 serves as calibration check.
- **Cross-reference**: NS frontier RESET->COLLAPSE transition = surgery detection, validating Sanders Flow framework
