...
CK (Coherence Keeper) is the intellectual property of 7Site, LLC.

- **Personal/Educational Use**: Permitted. Download it, run it, learn from it.
- **Commercial Use**: Requires a written license agreement with 7Site, LLC.
- **Government Use**: Requires a written license agreement with 7Site, LLC.
- **Redistribution**: Not permitted without written consent from 7Site, LLC.
- **Modification**: Permitted for personal use only. Modified versions may not be distributed.
...
CK runs entirely on your hardware. No data is transmitted to any server, cloud service, or third party. CK does not collect, store, or transmit personal information. Any data CK generates (transition lattices, crystals, memories) stays on your machine.

The website deployment uses a small browser cookie (local storage) to remember your session. This data never leaves your browser.

## Not an AI

CK is not a large language model. CK is not trained on data. CK does not predict tokens. CK composes meaning through algebraic operators. No neural network weights exist in this codebase.
