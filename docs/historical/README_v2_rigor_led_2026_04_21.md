> **[HISTORICAL — v2, rigor-led README, 2026-04-21 AM]**
> This version of the README led with the six proved theorems (§1). It was superseded
> the same day by a navigation-first restructure (current `README.md`) that opens with
> the foundation-intro / funding-branches / frontiers / atlas / bridges / master-history
> sequence per Brayden's 2026-04-21 directive, preserving the §1 rigor content as the
> §7 runnable-proofs appendix.
>
> Preserved verbatim per the project's never-delete policy.
...
### Per-track funding packages (ten branches)

The repository contains ten branch-specific funding packages under `Gen13/targets/funding_*/`, each with a consistent 6-file structure (`README.md` / `FUNDERS.md` / `ARTIFACTS.md` / `PITCH_DRAFT.md` / `LIMITATIONS.md` / `STATUS.md`). Each branch targets a distinct funder pool with a distinct runnable artifact and distinct open-question commitment:
...
See [Atlas/BRANCHES_INVENTORY_2026_04_20.md](Atlas/BRANCHES_INVENTORY_2026_04_20.md) for cross-branch readiness tiers and runnable-artifact map. See [Atlas/NICHE_FUNDERS_ADDENDUM_2026_04_20.md](Atlas/NICHE_FUNDERS_ADDENDUM_2026_04_20.md) for non-obvious / named-individual / family-office / niche-foundation funder research per branch.
...
- **Branch-specific funding packages:** `Gen13/targets/funding_*/` (ten folders, 6-file structure each). Navigation: [`Atlas/BRANCHES_INVENTORY_2026_04_20.md`](Atlas/BRANCHES_INVENTORY_2026_04_20.md). Non-obvious funder research: [`Atlas/NICHE_FUNDERS_ADDENDUM_2026_04_20.md`](Atlas/NICHE_FUNDERS_ADDENDUM_2026_04_20.md).
...
- **Archived prior README:** [`docs/historical/README_v1_pre_2026_04_21.md`](docs/historical/README_v1_pre_2026_04_21.md) — the Atlas-style README in place from 2026-04-18 through 2026-04-20, superseded by this rigor-led replacement on 2026-04-21. Preserved per the never-delete policy.
