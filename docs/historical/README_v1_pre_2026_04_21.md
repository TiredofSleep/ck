...
> This document is the Atlas-style `tig-synthesis` README that was in place from ~2026-04-18 through 2026-04-20. It has been superseded on 2026-04-21 by a rigor-led funder-facing README (commit message: `README: rigor-led replacement for funding outreach`) per the never-delete policy. Preserved here verbatim for reference.
>
> For the current README, see [/README.md](../../README.md) on the `tig-synthesis` branch.
>
> **Why the replacement.** The replacement README leads with six proved theorems with runnable verification (§1), then describes the Coherence Keeper deterministic-reasoning engine (§3), open research directions (§4), honest scope (§5), funding (§6), and attribution (§7). Atlas-style speculation, vocabulary primers, and the Six-Shadows Clay-rotation framing have been moved to deeper material (§8 pointers) rather than living on the front page. The goal: a funder, journal editor, or external mathematician lands on proved theorems first, with speculation signposted and deferred. The older document below is preserved because it carries the project's self-understanding during the Sprint 17–28 period and because deleting it would violate the never-delete policy.
...
> - **Constants** — T*, 4/π², W=3/50, BALANCE/10, HARMONY/10, 1/70, Si(2π)/π, ξ₀, m²_ξ, γ(b)=1−1/φ(b), 22%, 4.6%, det(BHML)=70, g=3
...
|----------|-------|--------|--------|
| **T\*** | 5/7 = 0.71428... | Six independent derivations: Φ fixed point, TSML BALANCE/HARMONY ratio, cyclotomic obstruction, Flatness torus aspect, UOP injectivity boundary, FPGA silicon | [PROVED] WP51, proof_d7_phi_fixed_point.py |
