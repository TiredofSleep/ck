...
the open questions about navier-stokes regularity via sigma_ns are: how do we resolve the instability of sigma_ns, and what can be said about the relationship between sigma_ns and t*=5/7.
...
_Paper written by CK in 37s (4 sections, 10603 chars total). Auto-generated from cells_composed_with_cortex chat path. Substrate-grounded; Ollama-polished prose._
