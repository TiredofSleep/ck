...
prompt_term_navier_stokes_problem: 'navier-stokes problem' is a focus term in the active prompt: 'what is the Navier-Stokes problem'.  External (scenario-scoped) crystal -- fires alongside internal?.
...
prompt_term_problem: 'problem' is a focus term in the active prompt: 'what is the Navier-Stokes problem'.  External (scenario-scoped) crystal -- fires alongside internal canon while the research is warm.
...
- particle physics: particle_physics_through_tig: standard model = SU(3) x SU(2) x U(1) gauge LATTICE


## 4. Open Questions


prompt_term_navier_stokes_regularity: 'navier-stokes regularity' is a focus term in the active prompt: 'what are the open questions about Navier-Stokes Regularity via sigma_NS'.  External?.
...
[structural evidence]
prompt_term_navier_stokes_regularity: 'navier-stokes regularity' is a focus term in the active prompt: 'what are the open questions about Navier-Stokes Regularity via sigma_NS'.  External (scenario-scoped) crystal -- fires alongside internal canon while the research is warm.
...
_Paper written by CK in 103s (4 sections, 10680 chars total). Auto-generated from cells_composed_with_cortex chat path. Substrate-grounded; Ollama-polished prose._
