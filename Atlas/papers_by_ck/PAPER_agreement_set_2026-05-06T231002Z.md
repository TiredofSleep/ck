...
prompt_term_agreement_set: 'agreement set' is a focus term in the active prompt: 'what is the agreement set of TSML and BHML'.  External (scenario-scoped) crystal -- fires alongside internal canon?.
...
_Paper written by CK in 147s (4 sections, 6628 chars total). Auto-generated from cells_composed_with_cortex chat path. Substrate-grounded; Ollama-polished prose._
